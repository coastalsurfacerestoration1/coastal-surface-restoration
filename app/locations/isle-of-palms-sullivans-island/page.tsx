      ...
      <section className="py-16 bg-[#0d1f3c] border-t border-[#0e7c7b]/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-xl mx-auto">
            Free estimates on every job. Send a photo of the railing, fixture, or hardware and we will tell you what laser cleaning can do for it, usually within 24 hours. Minimum job size $400.
          </p>
          <Link
            href="/quote"
